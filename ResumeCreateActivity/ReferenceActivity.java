...
import com.naman.resumemaker.Adapter.ReferenceAdapter;
...
public class ReferenceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = (TextView)findViewById(R.id.add_reference);
        FloatingActionButton fab = (FloatingActionButton)findViewById(R.id.btn_add);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Util.ref_id = 0;
                Intent intent = new Intent(ReferenceActivity.this, ReferenceDetails.class);
        ...
        listView = (ListView) findViewById(R.id.reference_list);
    ...
    protected void onResume() {
        ...
        try {
            ...
            cursor = adpt.queryNameRefer(Util.resumeid);
            ref_id = new String[cursor.getCount()];
            ref_name = new String[cursor.getCount()];
            int i = 0;
            if (cursor.moveToFirst()) {
                do {
                    ref_id[i] = cursor.getString(1);
                    ref_name[i] = cursor.getString(2);
                    i++;
                } while (cursor.moveToNext());
            }
            listView.setAdapter(new ReferenceAdapter(this, ref_id, ref_name));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
